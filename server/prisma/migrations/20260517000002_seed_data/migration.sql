...
('DeepSeek Chat', 'deepseek', 'https://api.deepseek.com', 'your-api-key-here', 'deepseek-chat', true, UNIX_TIMESTAMP() * 1000, UNIX_TIMESTAMP() * 1000),
('OpenAI GPT-4', 'openai', 'https://api.openai.com', 'your-api-key-here', 'gpt-4o', true, UNIX_TIMESTAMP() * 1000, UNIX_TIMESTAMP() * 1000);
