import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, ref, shallowRef, watch, hasInjectionContext, inject, h, getCurrentInstance, nextTick, defineAsyncComponent, Suspense, Fragment, createApp, provide, shallowReactive, computed, unref, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, mergeProps, getCurrentScope, toRef, isReadonly, useSSRContext, isRef, isShallow, isReactive, toRaw } from 'vue';
import { g as defuFn, c as createError$1, w as parseURL$1, i as encodePath$1, d as decodePath, p as hasProtocol, r as isScriptProtocol, s as joinURL, B as withQuery, t as klona, y as sanitizeStatusCode, k as getContext, $ as $fetch$1, b as baseURL, j as executeAsync, f as defu } from '../nitro/nitro.mjs';
...
const unhead_4hZnxd9RyA3075RGiJGfJmeVyVMkZdZw11eVwet3AWQ = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index--iIkcG32.mjs')
  }
];
...
const revive_payload_server_lcFiNAdjgeGcDh4k8qt10Xes0TqNG_MIzKd_BAvk5cg = /* @__PURE__ */ defineNuxtPlugin({
...
const plugin_vS_u6v7GrDwDE2DS_sz5TRcFnsL8yf0wq5gbsC_12wc = /* @__PURE__ */ defineNuxtPlugin({
  name: "@nuxt/icon",
  setup() {
...
const LazyIcon = defineAsyncComponent(() => import('./index-Cl9IQagg.mjs').then((r) => r["default"] || r.default || r));
...
const colors_jwpJ2K_ErhWaTHb77ZL_ch96DiXDqP6HKgpQJBPWXWo = /* @__PURE__ */ defineNuxtPlugin(() => {
...
const plugins = [
  unhead_4hZnxd9RyA3075RGiJGfJmeVyVMkZdZw11eVwet3AWQ,
  plugin,
  revive_payload_server_lcFiNAdjgeGcDh4k8qt10Xes0TqNG_MIzKd_BAvk5cg,
  plugin_server_XlivkfYBOcHtXydUVsxvbfczHZpJKCMwq769UkFyeKk,
  plugin_vS_u6v7GrDwDE2DS_sz5TRcFnsL8yf0wq5gbsC_12wc,
  components_plugin_4kY4pyzJIYX99vmMAAIorFf3CnAaptHitJgf7JxiED8,
  colors_jwpJ2K_ErhWaTHb77ZL_ch96DiXDqP6HKgpQJBPWXWo
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CJtlsYs_.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BrVB2LmF.mjs'));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@4.4.5_@babel+core@7.29.0_@babel+plugin-syntax-jsx@7.28.6_@babel+core@7.29.0__@parc_9f91b36a82e4a92136c5cd0bf06c77a4/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@4.4.5_@babel+core@7.29.0_@babel+plugin-syntax-jsx@7.28.6_@babel+core@7.29.0__@parc_9f91b36a82e4a92136c5cd0bf06c77a4/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { Icon as I, _export_sfc as _, appConfig as a, asyncDataDefaults as b, createError as c, nuxtLinkDefaults as d, entry_default as default, encodeRoutePath as e, useHead as f, getIcon as g, useNuxtApp as h, useRoute as i, useRouter as j, useRuntimeConfig as k, loadIcon as l, navigateTo as n, resolveRouteObject as r, useAppConfig as u };
